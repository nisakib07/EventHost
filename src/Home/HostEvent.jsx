...
const HostEvent = () => {
  return (
    <Wrapper>
      <div className="mt-10 bg-gradient-to-br from-[#7B4AFF] to-[#8053FA] rounded-lg py-12 px-8 flex items-center gap-10 relative">
        <img
          className="w-2/5 border-2 border-dashed p-2"
          src={hostImg}
          alt=""
        />
